...
public class GoogleStepDefs {
    ...
    public void i_search_for_hjkdshjdkshfnksjndskbhjshb(String searchCriteria) {
        googleSearchPage = GoogleSearchPage.instanciateGoogleSearchPage(driver); //bc ur constructor are private
