...
public class OpenMRSStepDef {
    ...
    public void i_register_a_new_patient_with_jerry_white_male_chicago_and(String firstName, String lastName, String gender,  Integer day,
                                                                           String month, Integer year, String city, Integer phone) {
